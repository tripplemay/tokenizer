...
- **BL-HARNESS-DETAIL-MODEINTENT（reverifying，5/6 completed，fix_round 1）**：Harness 项目卡下钻、签名模式意图、下一次 `/plan` 消费、脱敏 dispatch 历史。
...
- F003 窄修复已提交 `41b64dd`：仅允许 feature title 的已知 Harness command，F006 等待 Kimi 复验。
