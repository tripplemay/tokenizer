...
- **BL-HARNESS-REPORT-COMPAT（verifying，4/4，fix_round 1）**：修复三个真实 `sensitive_summary_data`，等待一次性人工闸门。
...
- 人工闸门：`BL-HARNESS-REPORT-COMPAT-verifying-done-w1` 已举起；批准只把批次置 done，不推送或部署。
