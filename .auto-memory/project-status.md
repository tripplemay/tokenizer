...
- **BL-HARNESS-REPORT-COMPAT（done，4/4，fix_round 1）**：修复三个真实 `sensitive_summary_data`；人工闸门已验签消费。
...
- 人工闸门：`BL-HARNESS-REPORT-COMPAT-verifying-done-w1` 已由 `tripplezhou@gmail.com` 一次性批准，签名有效并已消费；本批仍未推送或部署。
