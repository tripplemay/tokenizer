        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="text-gray-500">
              <tr>
                <th className="pb-3">{t("events.col.time")}</th>
                <th className="pb-3">{t("events.col.project")}</th>
                <th className="pb-3">{t("events.col.source")}</th>
                <th className="pb-3">{t("events.col.model")}</th>
